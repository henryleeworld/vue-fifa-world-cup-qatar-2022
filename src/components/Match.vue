        ...
        <div class="vs">
            <div>
                <div class="home">
                    ...
                    <span v-else >{{ match.home_team.name == 'To Be Determined' ? "待確認" : match.home_team.name }}</span>
                </div>
            ...
            <div>
                ...
                <div class="away">
                    ...
                    <span v-else >{{ match.away_team.name == 'To Be Determined' ? "待確認" : match.away_team.name }}</span>
                </div>
            </div>
        </div>
    </div>
